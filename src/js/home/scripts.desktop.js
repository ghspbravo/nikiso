...
, function(t, e, i) {
  ...
  o = function() {
      ...
      return s(t, [{
          key: "_onClickLink",
          value: function(t) {
            return; // prevent custom link behaviour
              if (1 !== t.button) {
                  t.preventDefault();
          ...
          key: "_onPopState",
          value: function(t) {
            return; //prevent changing location
              var e = t.detail
              ...
              value: function() {
                  ...
                  for (var t = void 0, i = void 0, r = 0, n = this._itemsPosition.length; r < n; ++r) {
                      ...
                      if (!this.isLocked && o > -1.5 && o < 1.5) {
                          ...
                          s.wrapper && p.default.transform(s.wrapper, "translate3d(" + c + "px,0,0)"),
                          s.btnDom && p.default.transform(s.btnDom, "translate3d(" + -2 * f + "px,0,0)")
                      }
      ...
      var a, l = function() {
          ...
          l(e, [{
              ...
              value: function() {
                  ...
                  f.default.touchOnly || (this._video.load(),
                  this._video.play()),
                  this._job = $(".job", this.dom)[0],
                  this._openTab = $(".open-tab", this.dom),
                  this.bind()
              }
          }, {
              key: "bind",
              ...
              value: function() {
                  u(e.prototype.__proto__ || Object.getPrototypeOf(e.prototype), "resize", this).call(this),
                  this._backgroundHead.resize(),
                  this._video && v.default.setAsCover(this._video),
                  this._jobMarginBottom || (this._jobMarginBottom = parseInt(window.getComputedStyle(this._job).marginBottom))
              }
          }, {
              key: "update",
              value: function() {
          ...
          return s(t, [{
              ...
              value: function(t) {
                  ...
                  if (this.index !== e) {
                      ...
                      l.default.transform(this.dom, "translate3d(" + r + "px,0,0)")
                  }
              }
          }, {
              key: "getNodeindex",
